...
<html lang="en">
  <head>
    ...
    <!-- Favicons -->
    <link href="{{ asset('/NiceAdmin/assets/img/pplg.png')}}" rel="icon">
    <link href="{{ asset('/NiceAdmin/assets/img/pplg.png')}}" rel="apple-touch-icon">
  ...
  <body class="bg-light">
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/autoNumeric/4.6.2/autoNumeric.min.js"></script>
